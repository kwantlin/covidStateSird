...
velocModel <- R2jags::jags(data = velocLogCasesList, inits = NULL, parameters.to.save = params,
  model.file = riasJagsModel, n.chains = 3, n.iter = 200000, n.burnin = 10000, n.thin = 500, DIC = F)
...
# posteriorSamples, rfError = T, plots = T, endPlotDay = "2021-03-01")

 for(i in 1:length(states)) {
   stateSird(states[i], covariates, stateInterventions, stateCovidData, randomForestDeathModel,
   posteriorSamples, rfError = T, endPlotDay = "2021-03-01")
 }
```
